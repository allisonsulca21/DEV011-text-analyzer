...
* El objetivo principal de un texto es enviar un mensaje claro y fácil de entender, sin importar de qué trate, para que la persona que lo lea lo pueda entender bien.
* Actualmente, se ha hecho evidente la importancia de analizar estos textos con el objetivo de extraer información valiosa de los mismos.
